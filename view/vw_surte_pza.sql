...
select j.ranking, j.cod_cliente, j.nom_cliente, p.nro_pedido, p.itm_pedido, j.fch_pedido, j.ot_tipo
     ...
     , j.fch_impresion, j.tiene_stock_ot, p.cod_pza, p.cantidad, p.cant_final, p.stock_inicial, p.stock_actual
     , p.saldo_stock , p.sobrante, p.faltante, p.linea, p.rendimiento
