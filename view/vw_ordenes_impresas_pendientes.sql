...
select cod_cliente, nombre, fch_pedido, pedido, pedido_item, nuot_tipoot_codigo, nuot_serie, numero, fecha
     , estado, pais, vendedor, empaque, formu_art_cod_art, valor, dias_impreso, fch_impresion, es_juego
     , es_prioritario
  from vw_ordenes_impresas_piezas
 group by cod_cliente, nombre, fch_pedido, pedido, pedido_item, nuot_tipoot_codigo, nuot_serie, numero, fecha
        , estado, pais, vendedor, empaque, formu_art_cod_art, valor, dias_impreso, fch_impresion, es_juego
        , es_prioritario
