create or replace view vw_ordenes_pedido_pendiente as
  with stock_actual as (
    ...
    select h.abre01 as pedido, h.per_env as pedido_item, h.numero, h.nuot_serie, h.nuot_tipoot_codigo, h.fecha
     ...
     , pedidos as (
    -- exportacion
    select p.numero as pedido, d.nro as pedido_item, p.cod_cliente, coalesce(c.abreviada, p.nombre) as nombre
         , p.fecha as fch_pedido, o.numero, o.nuot_serie, o.nuot_tipoot_codigo, o.fecha, o.jaba, o.estado
         , o.rendimiento, o.destino, o.art_cod_art, o.cant_formula, o.saldo, o.despachar, o.cod_lin
         , o.formu_art_cod_art, o.abre02, o.es_juego, o.impreso, o.fch_impresion, o.es_importado, d.preuni
...
-- nacional
    select p.numero as pedido, d.nro as pedido_item, p.cod_cliente, p.nombre
         ...
         , o.rendimiento, o.destino, o.art_cod_art, o.cant_formula, o.saldo, o.despachar, o.cod_lin
         , o.formu_art_cod_art, o.abre02, o.es_juego, o.impreso, o.fch_impresion, o.es_importado, d.preuni
         , p.pais, 'PE' as vendedor, p.empaque, o.es_sao, o.cant_prog
         , round(d.canti * d.preuni, 2) as valor
      from expednac p
           join expednac_d d
                on p.numero = d.numero
    ...
    select nvl(gcc.cod_grupo, p.cod_cliente) as cod_cliente
         ...
         , p.formu_art_cod_art, p.abre02, nvl(s.stock, 0) as stock, p.preuni, p.valor, p.es_sao, p.cant_prog
